...
class ImageToVideoSetting(BaseModel):
    ...
    def __str__(self):
        return f"I2V Setting (Active: {self.is_active})"

class ImageToVideoModelPricing(BaseModel):
    ...
    def __str__(self):
        return f"I2V - {self.model_name} ({self.fixed_cost_720p} credits)"
...
class ImageToVideoGeneration(BaseModel):
    ...
    class Meta:
        verbose_name = "سجل توليد فيديو من صورة / I2V Record"
        verbose_name_plural = "سجلات توليد الفيديو من صورة / I2V Records"
